...
F_corechains = open("data/lcquad_train_corechain.txt", "w")
F_error = open("data/lcquad_train_corechain_error.txt", "w")
F_terminal = open("data/lcquad_train_terminal.txt", "w")
F_time = open("data/lcquad_train_time.txt", "w")
F_has_no_ans = open("data/lcquad_train_has_no_ans.txt", "w")

F_error_lcquad_query = open("data/lcquad_train_runningquery_error_not_imp.txt", "w")
...
#scp ssh ahmad.alzeitoun@sda-srv04.iai.uni-bonn.de:/data/ahmad.alzeitoun/dev/ThesisProject/data/lcquad_sbert_e6_b64.txt /Users/University/Desktop
#scp /Users/University/Development/DevThesis/ThesisProject/data/lcquad2_dataset/lcquad_train_answer_classification_filterORorder.txt ssh ahmad.alzeitoun@sda-srv04.iai.uni-bonn.de:/data/ahmad.alzeitoun/dev/ThesisProject/data/lcquad2_dataset
